...
const WITH_TRANSACTIONS = [
  ...
  '12/16  Zelle Payment From Jennifer Lew 0Jj0Ubo1Zzug  6,841.76',
  '12/17  Zelle Payment To Steven Wu Jpm99Bxqdxks  -30.06  6,811.70',
  '',
  'TRANSACTION DETAIL',
  'IN CASE OF ERRORS',
].join('\n');
...
describe('ChaseParser.parse — metadata', () => {
  ...
  it('parses account number', () => expect(d.account_number).toBe('000000106569236'));
...
describe('ChaseParser.parse — year from period, not first /\\d{4}/', () => {
  // The account number 000000106569236 contains many digits that could be
