...
class TestKimiFilesRouterAuthenticated:
    ...
    def test_list_kimi_files_success(self, mock_get_service, client):
    ...
    @patch("app.routers.kimi_files.get_kimi_service")
    def test_list_kimi_files_upstream_error(self, mock_get_service, client):
    ...
    @patch("app.routers.kimi_files.get_kimi_service")
    def test_delete_kimi_file_success(self, mock_get_service, client):
    ...
    @patch("app.routers.kimi_files.get_kimi_service")
    def test_delete_kimi_file_not_found(self, mock_get_service, client):
        ...
        response = client.delete("/api/v1/kimi-files/nonexistent")
