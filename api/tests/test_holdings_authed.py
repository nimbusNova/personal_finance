...
class TestHoldingsRouterAuthenticated:
    ...
    def test_get_holdings_with_data(self, client, test_account, db_session):
    ...
    def test_get_holdings_by_snapshot_id(self, client, test_account, db_session):
        ...
        response = client.get(f"/api/v1/holdings?snapshot_id={snapshot2.id}")
    ...
    def test_get_holdings_by_account_id(self, client, test_institution, db_session):
        """Test filtering holdings by account_id"""
        # Create two accounts
        account1 = Account(institution_id=test_institution.id, name="Account1", account_type="brokerage")
        account2 = Account(institution_id=test_institution.id, name="Account2", account_type="brokerage")
        ...
        response = client.get(f"/api/v1/holdings?account_id={account1.id}")
    ...
    def test_get_holdings_weight_pct_calculation(self, client, test_account, db_session):
    ...
    def test_get_holdings_latest(self, client, test_account, db_session):
    ...
    def test_get_portfolio_summary(self, client, test_account, db_session):
    ...
    def test_get_portfolio_summary_with_bank_balances(self, client, test_institution, db_session):
        """Test portfolio summary includes bank account balances"""
        # Create brokerage account with holdings
        brokerage = Account(institution_id=test_institution.id, name="Brokerage", account_type="brokerage")
        ...
        bank_account = Account(institution_id=test_institution.id, name="Checking", account_type="bank")
    ...
    def test_get_portfolio_summary_with_cc_debt(self, client, test_institution, db_session):
        ...
        cc_account = Account(institution_id=test_institution.id, name="Credit Card", account_type="credit_card")
    ...
    def test_get_holdings_across_multiple_accounts(self, client, test_institution, db_session):
