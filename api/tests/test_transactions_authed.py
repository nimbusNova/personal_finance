...
class TestTransactionsRouterAuthenticated:
    ...
    def test_get_transactions_basic(self, client, test_account, db_session):
    ...
    def test_get_transactions_by_account_id(self, client, test_institution, db_session):
        """Test filtering transactions by account_id"""
        # Create two accounts
        account1 = Account(institution_id=test_institution.id, name="Checking", account_type="checking")
        account2 = Account(institution_id=test_institution.id, name="Savings", account_type="savings")
    ...
    def test_get_transactions_date_range(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions?start_date=2024-03-10&end_date=2024-03-20")
    ...
    def test_get_transactions_by_category(self, client, test_account, db_session):
    ...
    def test_get_transactions_min_amount(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions?min_amount=50")
    ...
    def test_get_transactions_combined_filters(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions?category=food&min_amount=75")
    ...
    def test_get_transactions_summary_monthly(self, client, test_account, db_session):
    ...
    def test_get_transactions_summary_no_data(self, client):
    ...
    def test_get_expensive_transactions_default(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions/expensive")
    ...
    def test_get_expensive_transactions_custom_threshold(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions/expensive?threshold=75")
    ...
    def test_get_expensive_transactions_by_month(self, client, test_account, db_session):
        ...
        response = client.get("/api/v1/transactions/expensive?year=2024&month=3")
    ...
    def test_update_transaction_category(self, client, test_account, db_session):
